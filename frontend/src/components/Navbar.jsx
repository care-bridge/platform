    ...
    <>
      <nav class="topnav">
          ...
          <li>
            <strong>
              <a href="/" class="contrast">
                CareBridge <img src={HandHeartIcon} />
              </a>
            </strong>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <a href="/need-help">
              Need help <img src={FirstAidIcon} />
            </a>
          </li>
          <li>
            <a href="/requests">
              Donate <img src={DonateIcon} />
            </a>
          </li>
          <li>
            <a href="/login-hospital">
              Hospital Portal <img src={HospitalIcon} />
            </a>
          </li>
          <li>
            <a href="/email-us">
              Email Us <img src={MailIcon} />
            </a>
          </li>
        </ul>
        ...
        <ul>
          ...
          <li
            id="auth-section"
            hx-get="http://localhost:5000/auth/navbar"
            hx-trigger="load"
            hx-swap="innerHTML"
          ...
          <li>
            <a
              ...
              class="contrast"
              target="_blank"
              href="https://www.github.com/omar-hossam/CareBridge"
            >
              <img src={GitHubIcon} />
            </a>
          </li>
